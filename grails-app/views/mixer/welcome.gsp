...
<g:render template="../templates/banner" />
				...
				<div class="span6">
					<ul class="navbar navbar-inverse navbar-fixed-top">
						<div class="navbar-inner">
					        <div class="container">
					          <g:link class="brand" controller="mixer" action="welcome">Metastyle</g:link>
					          <div class="nav-collapse collapse">
					            <ul class="nav">
					              <li class="active">
					                <g:link controller="mixer" action="welcome"><i class="icon-home"></i>Home</g:link>
					              </li>
					              <li class="">
					                <g:link controller="mixer" action="getSkeletons"><i class="icon-wrench"></i>Get Skeletons</g:link>
					              </li>
					              <li class="">
	...
	<section id="main-container">
		<div id="search-panel" class="span10 offset2">
			...
			<div class="row">
			    <g:form id="form-search" class="form-search offset1" url="[controller: 'mixer', action: 'searchTemplate']">
		...
		<div class="template-thumbnails span12 offset2">
			<g:each var="rtempl" in="${ recent }">
				<div id="template-iframe" class="template-group span4">
					...
					<div class="statistic">
						<span class="stat-user"><i class="icon-user"></i><g:link controller="mixer" action="showGuestTemplate" id="${ rtempl.user.id }">${ rtempl.user.username }</g:link></span>
						<span class="stat-views"><i class="icon-eye-open"></i>${ rtempl.views }</span>
						<span class="stat-like"><g:link controller="mixer" action="likeTemplate" id="${ rtempl.id }"><i class="icon-star"></i></g:link>${ rtempl.likes }</span>
			...
			<!-- <div class="template-group span4">
				...
				<div class="statistic">
					...
					<span class="stat-like"><g:link controller="mixer" action="like" id="template-id"><i class="icon-star"></i><img src="" alt="like" /></g:link></span>
				</div>
			</div>
			<div class="template-group span4">
				<iframe class="template-iframe" src="http://www.google.co.uk" frameborder="1" scrolling="no"></iframe>
