...
<g:render template="../templates/banner" />
				...
				<div class="span6">
					<ul class="navbar navbar-inverse navbar-fixed-top">
						<div class="navbar-inner">
					        <div class="container">
					          <g:link class="brand" url='[controller:"mixer", action:"welcome"]'>Metastyle</g:link>
	...
	<section id="main-container">
		...
		<div class="offset5">
			<g:paginate controller="mixer" action="searchTemplate" next="Next &rarr;" prev="&larr; Prev" max="5" total="${ total }" params="[query: query, format: format]" />
		</div>
	</section>
