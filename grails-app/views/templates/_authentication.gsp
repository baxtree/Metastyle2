<div class="authentication offset6">
	...
	<g:else>
		<span class="span4"><g:link controller="mixer" action="login"><i class="icon-signin"></i>Log In</g:link> | <g:link controller="mixer" action="register"><i class="icon-edit"></i>Register</g:link></span>
	</g:else>
</div>