...
import annotation.CSSTemplate
import annotation.GithubApi


class MixerController {

    static scaffold = Mixer
    ...
    def proxy2 = {
        redirect(controller: "mixer", action: "welcome2", fragment: "mostviews")
    }
    ...
    def proxy3 = {
        redirect(controller: "mixer", action: "welcome3", fragment: "popular")
    }
    ...
    def generateTemplate = {
        ...
        try{
            ...
            redirect(controller : "mixer", action : "getSkeleton")
        }
